...
describe('LinkedList', () => {
  ...
  test('delete does not modify the list if the element is not found, even with two elements', () => {
    const list = new LinkedList()
    list.push(89)
    list.push(88)
    list.delete(103)
  ...
  test('deletes only the first occurence, ver. A', () => {
    const list = new LinkedList()
    list.push(73)
    list.push(9)
    list.push(9)
  ...
  test('deletes only the first occurence, ver. B', () => {
    const list = new LinkedList()
    list.push(73)
    list.push(9)
    list.push(9)
