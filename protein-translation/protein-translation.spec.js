...
describe('ProteinTranslation', () => {
  ...
  test('Invalid codon throws error', () => {
    expect(() => translate('AU')).toThrow(new Error('Invalid codon'));
  });
  test('Invalid codon throws error', () => {
    expect(() => translate('AUAAAAA')).toThrow(new Error('Invalid codon'));
  });
  test('Invalid codon throws error', () => {
    expect(() => translate('G')).toThrow(new Error('Invalid codon'));
  });
});
